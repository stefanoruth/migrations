...
describe('Blueprint', () => {
    ...
    describe('Index', () => {
        test('Unique name', () => {
            ...
            expect(table.commands[0]).toBe('users_foo_bar_unique')
        })
        ...
        test('Index name', () => {
            ...
            expect(table.commands[0]).toBe('users_foo_index')
        })
        ...
        test('Unique name', () => {
            ...
            expect(table.commands[0]).toBe('geo_coordinates_spatialindex')
        })
    })
